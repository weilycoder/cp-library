...
data:
  ...
  attributes:
    document_title: Multiply two polynomials under modulo using MTT with 3 NTT-friendly
      moduli.
    links: []
  bundledCode: "#line 1 \"weilycoder/poly/mtt_convolve.hpp\"\n\n\n\n#line 1 \"weilycoder/poly/ntt_convolve.hpp\"\
    ...
    \ mod_add<mod>(R % mod, x);\n  };\n\n  for (size_t i = 0; i < n; ++i)\n    c[i]\
    \ = excrt(c1[i], c2[i], c3[i]);\n\n  return c;\n}\n} // namespace weilycoder\n\
    \n\n"
  code: "#ifndef WEILYCODER_POLY_MTT_CONVOLVE_HPP\n#define WEILYCODER_POLY_MTT_CONVOLVE_HPP\n\
    \n#include \"ntt_convolve.hpp\"\n#include <cstdint>\n\nnamespace weilycoder {\n\
    /**\n * @brief Multiply two polynomials under modulo using MTT with 3 NTT-friendly\
    \ moduli.\n * @tparam mod Target modulo.\n * @tparam mod1 First NTT-friendly modulo.\n\
    \ * @tparam mod2 Second NTT-friendly modulo.\n * @tparam mod3 Third NTT-friendly\
    \ modulo.\n * @tparam root1 Primitive root of mod1.\n * @tparam root2 Primitive\
    ...
    \ * @return Coefficients of the resulting polynomial after multiplication under\
...
documentation_of: weilycoder/poly/mtt_convolve.hpp
layout: document
redirect_from:
- /library/weilycoder/poly/mtt_convolve.hpp
- /library/weilycoder/poly/mtt_convolve.hpp.html
