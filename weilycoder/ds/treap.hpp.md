...
data:
  ...
  attributes:
    document_title: Reserve space for n nodes in the treap.
    links: []
  bundledCode: "#line 1 \"weilycoder/ds/treap.hpp\"\n\n\n\n#line 1 \"weilycoder/random.hpp\"\
    ...
    \ res;\n  }\n};\n} // namespace weilycoder\n\n\n"
  code: "#ifndef WEILY_CODER_DS_TREAP_HPP\n#define WEILY_CODER_DS_TREAP_HPP\n\n#include\
    \ \"../random.hpp\"\n#include <functional>\n#include <limits>\n#include <tuple>\n\
    #include <utility>\n#include <vector>\n\nnamespace weilycoder {\nstruct treap_base\
    ...
    \ pushup(size_t p) {\n    if (p != null)\n      nodes[p].size = node_size(nodes[p].left)\
    \ + node_size(nodes[p].right) + 1;\n  }\n\npublic:\n  Treap() = default;\n\n \
    \ /**\n   * @brief Reserve space for n nodes in the treap.\n   * @param n The\
    \ number of nodes to reserve space for.\n   */\n  void reserve(size_t n) { nodes.reserve(n);\
    \ }\n\n  /**\n   * @brief Create a new node with the given value and add it to\
    \ the treap.\n   * @param value The value of the new node.\n   * @return The index\
    \ of the new node.\n   */\n  size_t new_node(const T &value) {\n    if (free_list.empty())\
    \ {\n      nodes.emplace_back(value);\n      return nodes.size() - 1;\n    } else\
    \ {\n      size_t p = free_list.back();\n      free_list.pop_back();\n      nodes[p]\
  ...
  requiredBy: []
  timestamp: '2025-11-10 07:42:00+08:00'
  verificationStatus: LIBRARY_ALL_AC
  verifiedWith:
  - test/ordered_set.test.cpp
documentation_of: weilycoder/ds/treap.hpp
layout: document
redirect_from:
- /library/weilycoder/ds/treap.hpp
- /library/weilycoder/ds/treap.hpp.html
